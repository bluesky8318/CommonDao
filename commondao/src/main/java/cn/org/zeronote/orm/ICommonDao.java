...
public interface ICommonDao {
	 ...
	 * @param pojoType
	 * @param args
	 * @param requireFielsd	请求中必须填充的pojo field，如果为空，则全部获取
	 * @return
	 * @throws DataAccessException
	 */
	public <T> List<T> queryForPojoList(Class<T> pojoType, Map<String, Object> args, String... requireFielsd) throws DataAccessException;
