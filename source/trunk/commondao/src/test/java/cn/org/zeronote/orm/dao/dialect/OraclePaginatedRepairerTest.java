...
@ContextConfiguration(locations={"/META-INF/spring/test_cn.org.zeronote.orm.OraclePaginatedRepairer.xml"})
public class OraclePaginatedRepairerTest {
	...
	@Autowired
	private OraclePaginatedRepairer instance;
	...
	/**
	 * Test method for {@link cn.org.zeronote.orm.dao.dialect.OraclePaginatedRepairer#queryForPaginatedPojoList(javax.sql.DataSource, java.lang.String, java.lang.Object[], java.lang.Class, cn.org.zeronote.orm.RowSelection)}.
	 */
	@Test
	public void testQueryForPaginatedPojoList() {
		...
		RowSelection rowSelection = new RowSelection(0, 10, "pk_id");
